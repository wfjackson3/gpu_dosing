...
Size.create(:flow => 2, :pressure => 18, :line_id => Line.find_by_name("DME").id, :dnsize_id => Dnsize.find_by_size(8).id)
...
# DME kits
Valve.create(:partnumber => 96446836, :head_id => Head.find_by_typekey("PP").id, :gasket_id => Gasket.find_by_typekey("V").id, :ball_id => Ball.find_by_typekey("C").id, :dnsize_id => Dnsize.find_by_size(4).id, :line_id => Line.find_by_name("DME").id, :iskit => true)
Valve.create(:partnumber => 91134297, :head_id => Head.find_by_typekey("PP").id, :gasket_id => Gasket.find_by_typekey("V").id, :ball_id => Ball.find_by_typekey("T").id, :dnsize_id => Dnsize.find_by_size(4).id, :line_id => Line.find_by_name("DME").id, :iskit => true)
Valve.create(:partnumber => 96573952, :head_id => Head.find_by_typekey("PV").id, :gasket_id => Gasket.find_by_typekey("T").id, :ball_id => Ball.find_by_typekey("C").id, :dnsize_id => Dnsize.find_by_size(8).id, :line_id => Line.find_by_name("DME").id, :iskit => true)
